    ...
    <section className="footer-container">
     ...
     <div className="row mx-3">
        ...
        <div className="col-md-3">
          ...
          <a href="#"><FontAwesomeIcon icon={faGoogle}  className=' green-font icon'/></a>
          <a href="#"><FontAwesomeIcon icon={faFacebook}className='mx-3 green-font icon' /></a>
          <a href="#"><FontAwesomeIcon icon={faInstagram}className=' green-font icon' /></a>
        </div>
      </div>
